  ...
  PersonController_findManyAwardsV1_4: {
    parameters: {
      query?: {
        ...
        /** @description Список полей которые не должны быть null или пусты */
        notNullFields?: ("personId" | "winning" | "nomination.award.title" | "nomination.award.year" | "nomination.title" | "updatedAt" | "createdAt")[];
        /** @description Сортировка по полям из модели */
        sortField?: ("personId" | "winning" | "nomination.award.title" | "nomination.award.year" | "nomination.title" | "updatedAt" | "createdAt")[];
        /** @description Тип сортировки применительно к полям из sortField (пример: `"1", "-1"`) */
        sortType?: string[];
